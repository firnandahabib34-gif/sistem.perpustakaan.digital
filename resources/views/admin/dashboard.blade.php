    ...
    <div class="container mx-auto px-6 py-3">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('logout') }}" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg">
...
<div class="container mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold">Rp {{ number_format($totalFines ?? 0, 0, ',', '.') }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('admin.books') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
            <div class="flex items-center space-x-4">
        ...
        <a href="{{ route('admin.categories') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
            <div class="flex items-center space-x-4">
        ...
        <a href="{{ route('admin.loans') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
            <div class="flex items-center space-x-4">
        ...
        <a href="{{ route('admin.returns') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
            <div class="flex items-center space-x-4">
